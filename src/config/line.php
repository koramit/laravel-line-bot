...
return [
    ...
    'api_timeout_seconds' => env('LINE_API_TIMEOUT_SECONDS', 12),
    'api_connect_timeout_seconds' => env('LINE_API_CONNECT_TIMEOUT_SECONDS', 4),
    'api_retry_times' => env('LINE_API_RETRY_TIMES', 3),
    'api_retry_delay_milliseconds' => env('LINE_API_RETRY_DELAY_MILLISECONDS', 500),
];
